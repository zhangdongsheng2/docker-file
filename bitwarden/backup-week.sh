...
content_msg="222.week->oss://wuxiyuan/image/merger/===== Time:$backup_time"
...
echo $content_msg
#云端目录
oss_backup_dir=oss://wuxiyuan/image/merger-30m/
#进入待备份的父目录
cd /home
#备份压缩文件写入的目录
backup_dir=backup-dir
backup_file=$backup_dir/week$backup_time.tar.gz
#生成压缩备份
tar -zcvf $backup_file docker/nexus3 model/tsl-temp/bim-docker
#上传压缩备份

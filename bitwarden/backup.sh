...
#待备份的目录
backup_location=/home/sjs/bitwarden
#备份压缩文件写入的目录
backup_dir=$backup_location/bitwarden-bak
backup_file=$backup_dir/bitwarden$backup_time.tar.gz
#生成压缩备份
tar -zcvf $backup_file --exclude=$backup_dir $backup_location

#上传压缩备份
/home/sjs/ossutil64 cp $backup_file $oss_backup_dir
...
#清理7天前的备份
find $backup_dir -mtime +7 -type f -name '*.gz' |xargs rm -rf
